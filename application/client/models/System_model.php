...
class System_model extends CI_Model
{
    ...
    {
        $this->load->library('Data_exchange', array('api_name' => 'modify_ip', 'message' => $data), 'get_main');
...
select sum(a) as class, sum(b) as tea, sum(c) as stu, sum(d) as package, sum(e) as exp, sum(f) as section from (
 ...
 union
   select 0 as a, 0 as b, 0 as c, count(*) as d, 0 as e, 0 as f from  p_package where PackageParent=0 AND PackageStatus=1
 union 
