    ...
    <div class="main clearfix">
        ...
        <div class="content">
            ...
            <div class="total clearfix ">
                ...
                <a href="<?php echo site_url('Train/scenecreate');?>" id="addBtn" class="btnNew">+新增场景</a>
                <div class="search-a">
            ...
            <table class="scenetemplatelistTable" id="scenetemplatelistTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if($row['author'] == $this->userinfo['UserID']):?>
...
<script src="<?php echo base_url() ?>resources/js/teacher/train_scenelist.js" type='text/javascript'></script>
</body>
</html>