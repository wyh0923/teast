	...
	<div class="main clearfix">
       ...
       <!--right start-->
        <div class="content">
                ...
                <a href="<?php echo site_url('Subject/addtool');?>" class="btnNew" id="addBtn"><span>+</span>添加工具</a>
                <div class="search-a">
...
<script src="<?php echo base_url() ?>resources/js/teacher/tool_list.js" type='text/javascript'></script>
