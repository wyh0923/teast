...
<script src="<?php echo base_url() ?>resources/js/teacher/allclasses.js" type='text/javascript'></script>
       ...
       <!--right start-->
        <div class="content">
            ...
            <div class="total clearfix">
                ...
                <a href="<?php echo site_url('Classstaff/addclass');?>" id="" class="btnNew"><span>+</span>新建班级</a>


                <div class="search-a">
                    <input id="stuName" class="iptSearch-a esear" value="<?php echo $search?>" placeholder="请输入班级名称" type="text">
                    <i class="fa fa-search csear"></i>
                </div>
            </div>
            <table class="classList addClasName" id="" >
                <thead>
                ...
                <tbody id="teacherTbaleList">
                <?php foreach ($classes_list as $v): ?>
                    <tr>
                        <td> <input type="checkbox" name="checkTeacher" data-code="<?php echo $v['ClassID'];?>" onclick='checkThis("#teacherTbaleList","checkAll")'></td>
                        <td title="<?php echo $v['ClassName']?>"><?php echo $v['ClassName']?></td>
                        <td title=""><?php echo date('Y-m-d', $v['CreateTime'])?></td>
                        <td title=""><?php echo $v['StudentNum']?></td>
                        <td title=""><?php echo $v['TaskNum']?></td>
                        <td title=""><?php echo $v['TaskScore']?></td>

                        <td>
                            <a href="<?php echo site_url('Classstaff/classdetail').'/classid/'.$v['ClassID'];?>" class="forYellow"><i class="fa fa-search-plus" ></i>详情</a>
                            <a href="<?php echo site_url('Classstaff/editclass').'/classid/'. $v['ClassID']?>" class="forBlue" ><i class="fa fa-edit"> </i>编辑</a>
                            <a href="javascript:;" class="forRed delOne"  code="<?php echo $v['ClassID'];?>"><i class="fa fa-trash " ></i>删除 </a>
                        </td>
                    </tr>
                <?php endforeach;?>
