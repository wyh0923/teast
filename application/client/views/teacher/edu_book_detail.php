                                                ...
                                                if(isset($val['sectionlist']) && count($val['sectionlist']) > 0) {
                                                    ...
                                                    foreach ($val['sectionlist'] as $kk => $vv) {
                                                        ...
                                                        <div class="item clearfix">
                                                            <p class="itemTitle">
                                                                <a href="<?php echo site_url().'Education/sectiondetail?packageid='.$data['packageid'].'&sectionid='.$vv['SectionID'];?>"><?php echo $p.'.'.$u.'.'.$s.':'.$vv['SectionName'];?></a>
                                                            </p>
                                                            <div class="couseTime">
                                                            ...
                                                            ?>
                                                            <a href="<?php echo site_url().'Education/sectiondetail?packageid='.$data['packageid'].'&sectionid='.$vv['SectionID'];?>" class="starment courseState"><i class="<?php echo $biao;?>"></i><span>课程详情</span></a>
                                                        </div>
                                                        <?php
                                                        $s++;
                                                    }
