    ...
    <div class="main clearfix">
        ...
        <div class="content">
            ...
            <div class="lable_title">
                ...
                <a href="<?php echo site_url().'Education/edubook'?>" title="新建学习任务" class="for_lable">新建学习任务</a>&gt;
                <a href="<?php echo site_url().'Education/bookdetail?packageid='.$packageid;?>" title="<?php echo $packagename;?>" class="for_lable"><?php echo $packagename;?></a>&gt;
                        ...
                        foreach ($question as $key => $val) {
                                ...
                                <div class="Right">
                                    ...
                                    <ul>
                                        <?php foreach($QuestionChoose as $key=>$value){ ?>
                                            <li class=""><input disabled type="radio" name="<?php echo $val['QuestionID']; ?>" value="<?php echo $value ?>"  <?php echo $val['QuestionAnswer'] == $value ? 'checked' : '' ?>><label><?php echo $value; ?></label></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            ...
                            ?>
                                <div class="Right">
                                    ...
                                    <ul>
                                        <?php
                                        $okanswer = explode('|||',$val['QuestionAnswer']);
                                        foreach($QuestionChoose as $key=>$value){ ?>
                                            <li class=""><input disabled type="checkbox" name="<?php echo $val['QuestionID']; ?>" value="<?php echo $value ?>" <?php echo @in_array($value,$okanswer) ? 'checked' : ''; ?>><label><?php echo $value; ?></label></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            <?php }else if($val['QuestionType'] == 3){ ?>
                                <div class="Right">
                                    ...
                                    <?php ?>
                                    <ul>
                                        <input disabled class="answer" type="radio" name="<?php echo $val['QuestionID']; ?>" value="对" <?php if($val['QuestionAnswer'] == '对'){ echo 'checked';}?>><label>对</label>
                                        <input disabled class="answer" type="radio" name="<?php echo $val['QuestionID']; ?>" value="错" <?php if($val['QuestionAnswer'] == '错'){ echo 'checked';}?>><label>错</label>
                                    </ul>
                                </div>
                            <?php }else if($val['QuestionType'] == 4){ ?>
                                <div class="Right">
                                    ...
                                    <?php ?>
                                    <input disabled class="answer" type="text" name="<?php echo $val['QuestionID']; ?>" value="<?php echo $val['QuestionAnswer'];?>">
                                </div>
