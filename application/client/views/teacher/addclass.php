            ...
            <form action="" method="post" class="newClass">
                <div class="infoBox">
                    ...
                    <div class="listBox" id="truetype">
                        <span>学员：</span>
                        <label class="cur selectuser"><i class="fa fa-user bgYellow"></i>选择学员</label>
                        <label class="importuser"><i class="fa fa-upload bgYellow"></i>导入学员</label>
                    </div>
        ...
        <div class="infoBox">
            ...
            <div class="box-margin-cen popTable">
                ...
                <script type="text/javascript">
                    showSelfAjaxPagination('pageContainer', '<?php echo site_url() ?>'+'Classstaff/all_user', "sapSuc");
                </script>
            </div>
