...
<head>
    ...
    <script type="text/javascript">
        ...
        var SectionCode ="<?php echo $secid ?>";
        var uploadPath = "";//存储视屏路径
        var author ="<?php echo $this->session->userdata('Account') ?>";
        var videoDir = "<?php echo $upload_data['video_dir'];?>";

    </script>
    <script type="text/javascript" src="<?php echo base_url() ?>resources/js/teacher/addsection.js"></script>
    ...
    <div class="main clearfix">
        ...
        <div class="content">
            ...
            <div class="lable_title">
                <a href="<?php echo site_url('Subject/mybook')?>" class="for_lable">知识体系管理</a>&gt;
                <a href="<?php echo site_url('Subject/mybook')?>" class="for_lable">我的课程</a>&gt;
                <a href="<?php echo site_url('Subject/courseframe').'/cid/'.$cid?>" class="for_lable">结构</a>&gt;
                <a>编辑小节</a>
            </div>

            <!--面包屑导航 end-->
            <h3 class="lable_h3">编辑小节</h3>
                ...
                <form action="" method="post">
                    ...
                    <div class="infoBox">
                        <div class="iptBox clearfix">
                            ...
                            <input type="text" id="SectionName" value="<?php echo $section['SectionName']?>" class="ipt">
                        </div>
                        <div class="iptBox clearfix">
                            <span class="tit">内容简介：</span>
                            <textarea id="SectionDesc" class="multiTxt"><?php echo $section['SectionDesc']?></textarea>
                        </div>
                        <div class="iptBox clearfix" id="SectionGrade">
                            <span class="tit">难度：</span>
                            <label <?php if($section['SectionDiff']==0):?>class="cur"<?php endif;?> grade = '0'>
                                初级
                            </label>
                            <label <?php if($section['SectionDiff']==1):?>class="cur"<?php endif;?> grade = '1'>
                                中级
                            </label>
                            <label <?php if($section['SectionDiff']==2):?>class="cur"<?php endif;?> grade = '2'>
                                高级
                            </label>
                        </div>
                        <div class="iptBox clearfix" id="SectionType">
                            <input type="hidden" id="oldtype" value="<?php echo $section['SectionType']?>" />
                            <span class="tit">节类型：</span>
                            <label <?php if($section['SectionType']==0):?>class="cur"<?php endif;?> type='0'>理论节</label>
                            <label <?php if($section['SectionType']==1):?>class="cur"<?php endif;?> type='1'>CTF实验</label>
                            <label <?php if($section['SectionType']==2):?>class="cur"<?php endif;?>  type='2'>网络实验</label>
                        </div>
                        <div class="iptBox clearfix" id="SectionTypediv">
                            <div class = "SectionTypediv <?php if($section['SectionType']!=0):?>outHide<?php endif;?> SectionTypediv0 clearfix" id="SectionTypediv0">
                                <span class="tit"><nobr>*</nobr>上传视频：</span>
                                <div id="videoUploadBox" class="startUpBox bigInput">
                                </div>
                                <input type="text" id="SectionVideo" hidden disabled="disabled" value="<?php echo $section['VideoUrl']?>">

                            </div>
                            <div class = "SectionTypediv <?php if($section['SectionType']!=0):?>outHide<?php endif;?> SectionTypediv0 clearfix" id="SectionTypediv01">
                                <span class="tit"><nobr>*</nobr>视频时长：</span>
                                
                                <input type="text" class="ipt" id="VideoTime" value="<?php echo $section['VideoTime']?>" placeholder="请输入分钟数">分钟

                            </div>

                            <div class="SectionTypediv <?php if($section['SectionType']!=1):?>outHide<?php endif;?> clearfix SectionTypediv1" id="SectionTypediv1" >
                                ...
                                <div id="ctfSelectBox">
                                    <div class="selectBox">
                                        ...
                                        <input type="hidden" id="SectionCtfcode" code="<?php echo $ctfname ?>" value="<?php echo $section['CtfID']?>">
                                    </div>
                                </div>
                            </div>
                            <div class="SectionTypediv <?php if($section['SectionType']!=2):?>outHide<?php endif;?> clearfix SectionTypediv2" id="SectionTypediv2" >
                                <span class="tit"><nobr>*</nobr>选择场景：</span>
                                <div id="secneSelectBox">
                                    <div class="selectBox">
                                        <input type="text" class="selectInfoBox" id="SectionScene" disabled="true" value="<?php echo $scene_name?>" >
                                        <a class="selectBtn selectSceneButton" id="selectSceneButton" href="javascript:void(0)" >
                                            <i class="fa fa-upload selectBtnIcon"></i>
                                        </a>
                                        <input type="hidden" id="SectionScenecode" value="<?php echo $section['SceneUUID']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <script type="text/javascript">
                            $(document).ready(function(){
                                $('#file_info_show_box_1').val("<?php echo $section['VideoUrl']?>");//默认的视屏内容
                                $('#SectionCtf').val("<?php echo $ctfname ?>");//默认的ctf内容
                                $('#SectionScene').val("<?php echo $scene_name?>");//默认的secen内容
                            })
                        ...
                        <div class="iptBox clearfix">
                            ...
                            <textarea class="multiTxt" id="SectionDoc"><?php echo $section['SectionDoc']?></textarea>
                        ...
                        <div class="listBoxTable clearfix">
                            <table class="testPaperSubjectTable1" >
                                ...
                                <?php if(!empty($materail)):
                                    foreach ($materail as $kt => $t):
                                    ?>
                                    <tr>
                                        <td><?php echo $t['ToolName']?></td>
                                        <td><?php echo $t['ToolUrl']?></td>
                                        <td><a href="javascript:;" code="<?php echo $t['ID']?>" author="<?php echo $t['ToolUrl']?>" desc="<?php echo $t['ToolName']?>" qstype="<?php echo $t['ToolName']?>" onclick="delthisData(this)" class="forRed" ><i class="fa fa-trash-o"></i>删除</a></td>
                                    </tr>
                        ...
                        <div class="listBoxTable clearfix">
                            <table class="testPaperSubjectTable1">
                                ...
                                <tbody id="selectedQuestionTable">
                                <?php if(!empty($question)):
                                foreach ($question as $kq => $q):
                                ?>
                                    <tr>
                                        <td><?php echo $q['QuestionDesc']?></td>
                                        <td>
                                            <?php
                                        ...
                                        <td><?php echo $q['QuestionAuthor']?></td>
                                        <td>
                                            <input maxlength="3" typestatus="判断题" placeholder="请输入分数" class="score" code="<?php echo $q['QuestionID']?>" author="<?php echo $q['QuestionAuthor']?>" qstype="判断题" desc="<?php echo $q['QuestionDesc']?>" value="<?php echo $q['Score']?>" onchange="tongji()" id="id<?php echo $q['Score']?>" type="text"/>
                                        </td>
                                        <td>
                                            <a href="javascript:;" questioncode="<?php echo $q['QuestionID']?>" onclick=delSelectedQuestion(this)><i class="fa fa-trash-o"></i>删除</a>
                                        </td>
                                        <td>
                                            <input type="checkbox" class="chekisNo" qu-code="<?php echo $q['QuestionID']?>" onclick=tongji() />
                                        </td>
                                    </tr>
                                <?php endforeach; endif;?>
                                </tbody>
                        ...
                        <div class="listBoxTable clearfix btnBox">
                            <a  href="javascript:;" class=" publicOk" id="editAllNews">保存</a>
                        </div>
                    </div>
                </form>
            </div>
...
<div class="popUpset animated" id="selectDataBox">
    ...
    <div class="infoBox">
        ...
        <script type="text/javascript">
            showSelfAjaxPagination('dataPage', site_url+'Subject/datumlist', "sapSucData");
        </script>
...
<div class="popUpset animated" id="selectQuesBox">
    ...
    <div class="infoBox">
        ...
        <script type="text/javascript">
            showSelfAjaxPagination('choseQuesPage', site_url+'Subject/all_question', "sapSucQuesList");
        </script>
...
<div class="popUpset animated" id="ctfListBox" >
    ...
    <div class="infoBox">
        ...
        <script type="text/javascript">
            showSelfAjaxPagination('ctfPage', site_url+'Subject/ctflist', "sapSucCtf");
        </script>
...
<div class="popUpset animated" id="seceListBox">
    ...
    <div class="infoBox">
        ...
        <script type="text/javascript">
            showSelfAjaxPagination('secePage', site_url+'Subject/scenelist', "sapSucScene");
        </script>
