...
<div class="popUpset animated " id="endBox">
    <form action="" method="post">
        ...
        <div class="infoBox">
            <p class="promptNews">正在考试不能结束该实验</p>
            <div class="btnBox">
                <a href="javascript:;" class="publicOk hidePop-1">确定</a>
            </div>
        </div>
    </form>
</div>
...
<script type="text/javascript" src="<?php echo base_url() ?>resources/js/student/exam_vnc.js"></script>