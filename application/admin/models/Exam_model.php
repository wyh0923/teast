...
class Exam_model extends CI_Model{
    ...
    public function exam_list($where,$search='',$offset='',$num='',$sort=''){
        $this->db->select('t.TaskID,t.TaskCode,t.ExamID,SceneTaskID,t.TaskName,e.ExamType,u.UserName,TaskEndTime,TaskStartTime,TaskScore,TaskStartTime-UNIX_TIMESTAMP(now()) as Stime,TaskEndTime-UNIX_TIMESTAMP(now()) as Etime,(TaskEndTime-TaskStartTime) as TaskTime');
