...
<div class="popUpset animated " id="okBox">
    <form action="" method="post">
        ...
        <div class="infoBox">
            ...
            <!--<div class="btnBox">
                <a href="<?php echo site_url('User/student');?>" class="publicOk " id="">确定</a>
                <a href="javascript:;" class="publicNo hidePop-1" id="">取消</a>--><!--如果是子层弹窗，调用hidePop-2
                需要按钮解除注释即可
            </div>-->
        </div>
...
<script src="<?php echo base_url() ?>resources/js/admin/add_student.js" type='text/javascript'></script>
</body>
</html>