    ...
    <div class="main clearfix">
        ...
        <div class="content">
            ...
            <div class="total clearfix">
                ...
                <a href="javascript:;" onclick="delAllTeacher()" id="delAllBtn" class="btnNew delyoure">删除选中教员</a>
                <a href="<?php echo site_url('/User/addteacher');?>" id="addBtn" class="btnNew"><span>+</span>新建教员</a>
                <div class="search-a">
                    <input id="stuName" type="text" class="iptSearch-a" value="<?php echo $search;?>" placeholder="请输入教员名称">
                    <i class="fa fa-search"></i>
                </div>
            </div>
            <table class="classList" id="classTable" >
                <thead>
                <tr class="table-title">
                    <td width="60"><input type="checkbox" id="checkAll">全选</td>
                    <td width="100">教员姓名</td>
                    <td width="70" id="UserSex" code="<?php if ($sort && $sort['field']=='UserSex'):?><?php echo $sort['order'];?><?php endif;?>" ><a>性别
                            <i class="fa <?php if ($sort && $sort['field']=='UserSex' && $sort['order']=='DESC'):?>fa-sort-alpha-desc
                            <?php elseif ($sort && $sort['field']=='UserSex' && $sort['order']=='ASC'):?>fa-sort-alpha-asc
                            <?php else:?>fa-sort<?php endif;?>
                            "></i></a>
                    </td>
                    <td width="165" id="UserDepartment" code="<?php if ($sort && $sort['field']=='UserDepartment'):?><?php echo $sort['order'];?><?php endif;?>"><a>工作单位
                            <i class="fa <?php if ($sort && $sort['field']=='UserDepartment' && $sort['order']=='DESC'):?>fa-sort-alpha-desc
                            <?php elseif ($sort && $sort['field']=='UserDepartment' && $sort['order']=='ASC'):?>fa-sort-alpha-asc
                            <?php else:?>fa-sort<?php endif;?>
                            "></i></a>
                    </td>
                    <td  width="110" id="CreateTime" code="<?php if ($sort && $sort['field']=='CreateTime'):?><?php echo $sort['order'];?><?php endif;?>"><a> 创建时间
                            <i class="fa <?php if ($sort && $sort['field']=='CreateTime' && $sort['order']=='DESC'):?>fa-sort-alpha-desc
                ...
                <?php foreach ($teacher_list as $row): ?>
                    <tr>
                        <td> <?php if ($row['UserID'] != 3):?><input type="checkbox" name="checkTeacher" data-code="<?php echo $row['UserID'];?>"><?php endif;?></td>
                        ...
                        <td title=""><?php echo date("Y-m-d",$row['CreateTime']); ?></td>
                        <td>
                            <?php if ($row['IsLocked'] == 1):?>
                                <a href="<?php echo site_url('User/lock_user').'?usercode='.$row['UserID'].'&type=0&class=teacher';?>"><span class="btnDisable">启用</span></a>/禁用
                            <?php else:?>
                                启用/<a href="<?php echo site_url('User/lock_user').'?usercode='.$row['UserID'].'&type=1&class=teacher';?>"><span class="btnDisable">禁用</span></a>
                            <?php endif;?>
                        </td>
                        <td>
...
<div class="popUpset animated " id="delAll">
    <form action="" method="post">
        ...
        <div class="infoBox">
            <p class="promptNews">请确认是否删除所有选中的教员？</p>
    ...
    <form action="" method="post">
        ...
        <div class="infoBox">
            ...
            <div class="inputPop clearfix">
                ...
                <input id="useraccount" value="teacher" class="iptext" type="text" readonly disabled>
    ...
    <form action="" method="post">
        ...
        <div class="infoBox onCanBg">
            ...
            <div class="inputPop clearfix">
                ...
                <input id="useraccount1" value="teacher" class="iptext" type="text" readonly>
            </div>
            <div class="inputPop clearfix">
...
<script src="<?php echo base_url() ?>resources/js/admin/user_teacher.js" type='text/javascript'></script>
</body>
</html>