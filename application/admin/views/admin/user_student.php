    ...
    <div class="main clearfix">
        ...
        <div class="content">
            ...
            <div class="total clearfix">
                ...
                <a href="javascript:;" onclick="delAllTeacher()" id="delAllBtn" class="btnNew delyoure">删除选中学员</a>
                <a href="<?php echo site_url('/User/addstudent');?>" id="addBtn" class="btnNew"><span>+</span>新建学员</a>
                <div class="search-a">
                    <input id="ArchitectureName" class="iptSearch-a" placeholder="请输入学员姓名" value="<?php echo $search;?>" type="text"><i class="fa fa-search"></i>
                </div>
            </div>
            <table class="personList">
                ...
                <tr>
                    <td> <input type="checkbox" name="checkTeacher" data-code="<?php echo $row['UserID'];?>"></td>
                    <td title="<?php echo $row['UserName']; ?>"><?php echo $row['UserName']; ?></td>
                    <td title="<?php echo $row['UserSex']; ?>"><?php echo $row['UserSex']; ?></td>
                    <td title="<?php echo $row['UserDepartment']; ?>"><?php echo $row['UserDepartment']; ?></td>
                    <td title="<?php echo date("Y-m-d",$row['CreateTime']); ?>"><?php echo date("Y-m-d",$row['CreateTime']); ?></td>
                    <td>
                        <?php if ($row['IsLocked'] == 1):?>
                            <a href="<?php echo site_url('User/lock_user').'?usercode='.$row['UserID'].'&type=0&class=student';?>"><span class="btnDisable">启用</span></a>/禁用
                        <?php else:?>
                            启用/<a href="<?php echo site_url('User/lock_user').'?usercode='.$row['UserID'].'&type=1&class=student';?>"><span class="btnDisable">禁用</span></a>
                        <?php endif;?>
                    </td>
                    <td>
                        <a href="javascript:;" class="forYellow" code="<?php echo $row['UserID'];?>"><i class="fa fa-search-plus "></i>详情</a>
                        <a href="javascript:;" class="forBlue" code="<?php echo $row['UserID'];?>"><i class="fa fa-edit"> </i>编辑</a>
                        <a href="javascript:;" class="forRed" code="<?php echo $row['UserID'];?>"><i class="fa fa-trash"></i>删除 </a>
                    </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
    ...
    <form action="" method="post">
        ...
        <div class="infoBox">
            <div class="inputPop clearfix">
                ...
                <input id=""  value="" class="iptext" type="text">

            </div>
            <div class="inputPop clearfix">
                <span class="secongTitle popWidth80"><nobr>*</nobr>姓名：</span>
                <input id=""  value="" class="iptext" type="text" maxlength="30">

            </div>
            <div class="inputPop clearfix">
                <span class="secongTitle popWidth80"><nobr>*</nobr>用户名：</span>
                <input id="" value="" class="iptext" type="text" readonly disabled>

            </div>
            <div class="inputPop clearfix">
                <span class="secongTitle popWidth80">密码：</span>
                <input class="iptext"   value=""  type="password" maxlength="20">

            </div>
            <div class="inputPop clearfix">
                <span class="secongTitle popWidth80">确认密码：</span>
                <input class="iptext"   value="" type="password" maxlength="20">
            ...
            <div class="inputPop clearfix">
                ...
                <input type="radio" name="sex" value="男" id="" checked="checked"><span class="danX">男</span>
                <input type="radio" name="sex" value="女" id=""><span class="danX">女</span>


            </div>
            <div class="inputPop clearfix">
                <span class="secongTitle popWidth80">单位：</span>
                <input class="iptext"   value="" type="text" maxlength="50">

            </div>
            <div class="inputPop clearfix">
                <span class="secongTitle popWidth80">邮箱：</span>
                <input class="iptext"   value="" maxlength="30" type="email">

            </div>
            <div class="inputPop clearfix">
                <span class="secongTitle popWidth80">电话：</span>
                <input class="iptext"   value="" type="text" maxlength="20">

            </div>


            <div class="btnBox">
                <a href="javascript:;" class="publicOk " id="">录入系统</a>
                <a href="javascript:;" class="publicNo hidePop-1" id="">关闭</a><!--如果是子层弹窗，调用hidePop-2-->
...
<script src="<?php echo base_url() ?>resources/js/admin/user_student.js" type='text/javascript'></script>
</body>
</html>