        ...
        <div class="content">
            <div class="structureHead clearfix">
                ...
                <div class="lable_title">
                    <a href="<?php echo site_url('Adminsubject/mysystem')?>" title="知识体系管理" class="for_lable">知识体系管理</a>&gt;
                    <a href="<?php echo site_url('Adminsubject/mysystem')?>" title="知识体系管理" class="for_lable">全部体系</a>&gt;
                    <a>编辑体系</a>
                </div>
...
<div class="popUpset animated " id="selcourse" >
        ...
        <div class="infoBox height-550">
            ...
            <script type="text/javascript">
                showSelfAjaxPagination('pageContainer', '<?php echo site_url() ?>'+'/Adminsubject/ajax_course', "sapSuc");
            </script>
            <div class="btnBox">
                <a href="javascript:;" class="publicOk" id="ok">确定</a><!--如果是子层弹窗，调用hidePop-2-->
...
<script type="text/javascript" src="<?php echo base_url() ?>resources/js/admin/plan_edit.js"></script>
