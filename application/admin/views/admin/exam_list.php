        ...
        <div class="content">
            ...
            <!--面包屑导航  end-->
                ...
                <div class="total clearfix">
                    ...
                    <a href="<?php echo site_url('Adminsubject/addexam')?>" class="btnNew" id="addBtn"><span>+</span>新增试卷</a>
                    <div class="search-a">
                ...
                <table class="testPaperList">
                    ...
                    <?php foreach ($exams as $e):?>
                            <tr>
                                <td ><a href="<?php echo site_url('Adminsubject/examquestion').'?examid='.$e['ExamID']?>" target="_blank" class="forRed" title="<?php echo $e['ExamName']?>"><?php echo $e['ExamName']?></a></td>
