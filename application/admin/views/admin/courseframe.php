        ...
        <div class="content">	
            <div class="structureHead clearfix">
                ...
                <div class="lable_title">
                    <a href="<?php echo site_url('Adminsubject/mybook')?>" title="知识体系管理" class="for_lable">知识体系管理</a>&gt;
                                    ...
                                    <?php foreach ($cha['units'] as $kuni => $uni):?>
                                        ...
                                        <?php else: ?>
                                                <div class="itemActions forByYellow"  uniid="<?php echo $uni['CourseID']?>">
                                                    <a href="<?php echo site_url('Adminsubject/addsection').'/cid/'. $cid . '/uniid/'. $uni['CourseID']?>" target="_blank"><span class="adddBtn"><i class="fa fa-plus-circle fa-lg"></i>新增小节</span></a>
                                            ...
                                            <?php foreach ($uni['sections'] as $ksec => $sec):?>
                                                ...
                                                <?php else: ?>
                                                        <div class="itemActions forByYellow" secid="<?php echo $sec['SectionID']?>" sectype="<?php echo $sec['SectionType']?>" >
                                                            <a href="<?php echo site_url('Adminsubject/sectiondetail').'?packageid='.$cid.'&sectionid='.$sec['SectionID']?>" target="_blank"><span class="adddBtn" ><i class="fa fa-eye"></i>预览</span></a>
                                                            <a href="<?php echo site_url('Adminsubject/editsection').'/cid/'. $cid . '/secid/'. $sec['SectionID']?>" target="_blank"><span class="adddBtn"><i class="fa fa-edit"></i>编辑</span></a>
