    ...
    <div class="main clearfix">
        ...
        <div class="content">
            ...
            <div class="total clearfix">
                ...
                <a href="<?php echo site_url('Admintrain/add_vm');?>" class="btnNew" id="addBtn"><span>+</span>新增虚拟机</a>
                <div class="search-a">
            ...
            <table class="vmtemplatelistTable" id="vmtemplatelistTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a  target="_blank" href="<?php echo site_url('Admintrain/edit_vm').'?code='.$row['vm_tpl_uuid'].'&host_id='.$row['host_id'];?>" class=" forBlue">
...
<script src="<?php echo base_url(); ?>resources/js/admin/train_vmlist.js" type='text/javascript'></script>
</body>
</html>