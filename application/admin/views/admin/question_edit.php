...
<head>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>resources/js/admin/question_add_mod.js"></script>
    ...
    <div class="main clearfix">
        ...
        <div class="content">
            ...
            <div class="lable_title">
                <a href="<?php echo site_url('Adminsubject/questionlist')?>" title="知识体系管理" class="for_lable">知识体系管理</a>&gt;
                <a href="<?php echo site_url('Adminsubject/questionlist')?>" title="题目管理" class="for_lable">题目管理</a>&gt;
                <a>编辑题目</a>
            </div>
            <!--面包屑导航 end-->
            <!--title-->
            ...
            <div class="addQuesInner addCourseInner">
                ...
                <div class="clearfix btnBox">
                    ...
                    <a href="<?php echo site_url('Adminsubject/questionlist')?>" class="publicNo" id="">返回</a>
                </div>
...
<div class="popUpset animated " id="ctfListBox"  >
    ...
    <div class="infoBox">
        ...
        <script type="text/javascript">
            showSelfAjaxPagination('ctfPage', site_url+"/Adminsubject/ctflist", "ctfLists");
        </script>
...
<div class="popUpset animated " id="scenListBox" >
    ...
    <div class="infoBox">
        ...
        <script type="text/javascript">
            showSelfAjaxPagination('secePage', site_url+"/Adminsubject/scenelist", "seceLists");
        </script>
