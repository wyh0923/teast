...
<script type="text/javascript" src="<?php echo base_url() ?>resources/js/admin/question.js"></script>
       ...
       <!--right start-->
        <div class="content">
            ...
            <div class="total clearfix">
                ...
                <a href="<?php echo site_url('Adminsubject/addquestion')?>" class="btnNew" id=""><span>+</span>新增题目</a>
                <div class="search-a">
