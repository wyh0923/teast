    ...
    <div class="main clearfix">
        ...
        <div class="content">
            ...
            <div class="lable_title">
                <a href="<?php echo site_url('Admintrain/ctflist');?>" title="实训内容管理" class="for_lable">实训内容管理</a>&gt;<a href="<?php echo site_url('Admintrain/vmlist');?>" title="虚拟机模板管理" class="for_lable">虚拟机模板管理</a>&gt;
                <a>
                    编辑虚拟机模板
                </a>
            </div>
...
<script src="<?php echo base_url(); ?>resources/js/admin/train_edit_vm.js" type='text/javascript'></script>
</body>
</html>