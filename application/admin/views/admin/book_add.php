        ...
        <div class="content">
            ...
            <div class="addCourseInner">
                ...
                <div class="btnBox">
                    ...
                    <a href="<?php echo site_url('Adminsubject/mybook')?>" class="publicNo">返回</a>
                </div>
            </div>
        </div>
	<!--right stop-->
...
<script type="text/javascript" src="<?php echo base_url() ?>resources/js/admin/teach_upload.js"></script>
