    ...
    <div class="main clearfix">
        ...
        <div class="content">
            ...
            <div class="lable_title">
                <a href="<?php echo site_url('User/classes');?>" title="班级管理" class="for_lable">班级管理</a>&gt;
...
<!--删除确认-->
<div class="popUpset animated " id="delPopBox" >
...
<script src="<?php echo base_url() ?>resources/js/admin/class_detail.js" type='text/javascript'></script>
</body>
</html>