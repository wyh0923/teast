        ...
        <div class="infoBox height-550 onCanBg">
            <div class="bigInfo">
                ...
                <div class="popTable">
                    ...
                    <script type="text/javascript">
                        showSelfAjaxPagination('pageContainer', site_url+'/Admintrain/get_vm_list', "sapSuc");
                    </script>
...
<script type="text/javascript" src="<?php echo base_url();?>resources/js/admin/vmlayout/vmlayout.js" ></script>
<script src="<?php echo base_url(); ?>resources/js/admin/vmlistbox.js" type='text/javascript'></script>
<script src="<?php echo base_url(); ?>resources/js/admin/train_scenecreate.js" type='text/javascript'></script>
</body>
</html>