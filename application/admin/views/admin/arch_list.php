...
<script type="text/javascript" src="<?php echo base_url() ?>resources/js/admin/plan.js"></script>
       ...
       <!--right start-->
        <div class="content">
                <div class="myarchlist">
                    <h3 class="myarchlistTitle lable_h3">全部知识体系</h3>
              ...
              <table class="myarchlistTable color_block colorChange" id="">
                    ...
                    <?php foreach ($plans as $p):?>
                        <tr>
                            <td >
                                <a title="<?php echo $p['ArchitectureName']?>" href="<?php echo site_url('Adminsubject/editplan'). '/pid/'. $p['ArchitectureID']?>" class="forYellow"><?php echo $p['ArchitectureName']?></a>
                            </td>
                            <td >
                            ...
                            <td>
                                <a href="<?php echo site_url('Adminsubject/editplan'). '/pid/'. $p['ArchitectureID']?>"   class=" forBlue"><i class="fa fa-edit"></i>编辑</a>
