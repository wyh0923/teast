...
<script type="text/javascript" src="<?php echo base_url() ?>resources/js/admin/book.js"></script>
       ...
       <!--right start-->
        <div class="content">
            <div class="Filter">
                <div class="filter clearfix ">
                    ...
                    <div class="filterList">
                        <a title="全部" href="<?php echo site_url('Adminsubject/mybook')?>" <?php if($pid == ''):?>class="filterCur"<?php endif;?>>全部</a>
                        <?php foreach ($trains as $t):?>
                            <a title="" <?php if($pid == $t['ArchitectureID']):?>class="filterCur"<?php endif;?> href="<?php echo site_url('Adminsubject/mybook'). '/pid/' .$t['ArchitectureID']?>" ><?php echo $t['ArchitectureName']?></a>
                        <?php endforeach;?>
                    </div>
                </div>
                <div class="filter clearfix ">
                    ...
                    <div class="filterList">
                        <a title="全部" href="<?php echo site_url('Adminsubject/mybook'). '/pid/' .$pid?>" <?php if($aid == ''):?>class="filterCur"<?php endif;?>>全部</a>
                        <?php foreach ($sys as $s):?>
                            <a title="" <?php if($aid == $s['ArchitectureID']):?>class="filterCur"<?php endif;?> href="<?php echo site_url('Adminsubject/mybook'). '/pid/' .$s['ArchitectureParent']. '/aid/'. $s['ArchitectureID']?>" ><?php echo $s['ArchitectureName']?></a>
                        <?php endforeach;?>
                    </div>
                </div>
            </div>				
            <div class="total clearfix">
                ...
                <a href="<?php echo site_url('Adminsubject/addbook')?>" id="addBtn" class="btnNew"><span>+</span>新增课程</a>
                <div class="search-a">
                ...
                <?php foreach ($courses as $c):?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="forYellow"  href="<?php echo site_url('Adminsubject/courseframe'). '/cid/'. $c['PackageID']?>"><i class="fa fa-search-plus "></i>结构 </a>
