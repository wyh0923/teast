 ...
 * Time: 16:50
 */
class Admintrain extends ECQ_Controller
{
    ...
    public function ctflist()
    {
        ...
        $output_data['page_url'] = site_url('Admintrain/ctflist') . $pageurl . '/';
        ...
        $this->load->view('admin/train_ctflist', $output_data);
    }
    ...
    public function scenelist()
    {
        ...
        $output_data['page_url'] = site_url('Admintrain/scenelist') . $pageurl . '/';
        $output_data['page_count'] = ceil($output_data['total_rows'] / 10);
        $output_data['page_pre'] = $page;
        ...
        $this->load->view('admin/train_scenelist', $output_data);
    }
    ...
    public function scenecreate()
    {
        ...
        $this->load->view('admin/train_scenecreate', $output_data);
    ...
    public function vmlist()
    {
        ...
        $output_data['page_url'] = site_url('Admintrain/vmlist') . $pageurl . '/';
        $output_data['page_count'] = ceil($output_data['total_rows'] / 10);
        $output_data['page_pre'] = $page;
        ...
        $this->load->view('admin/train_vmlist', $output_data);
    }
    ...
    public function add_vm()
    {
        ...
        $this->load->view('admin/train_add_vm', $output_data);
    ...
    public function edit_vm()
    {
        ...
        if ($data = $this->input->post(NULL, TRUE)) {
            ...
            if (empty($code) OR empty($host_id)) {
                redirect(site_url('Admintrain/vmlist'));
            }
            $result = $this->Scene_model->get_vm_info($code, $host_id);
            if (empty($result)) {
                redirect(site_url('Admintrain/vmlist'));
            ...
            $this->load->view('admin/train_edit_vm', $output_data);
    ...
    public function vm_vnc()
    {
        ...
        $this->load->view("admin/train_vnc", $data);
    }
