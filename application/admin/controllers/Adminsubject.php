 ...
 * Time: 11:38
 */
class Adminsubject extends ECQ_Controller
{
    ...
    public function mysystem()
    {
        ...
        $data['page_url']=site_url('Adminsubject/mysystem'). $pageurl.'/';
        $data['page_count'] = $page_count;

        $data['page_pre']=$page;

        $this->load->view('admin/arch_list', $data);
    }
    ...
    public function editplan()
    {
        ...
        $this->load->view('admin/arch_edit', $data);
    }
    ...
    public function mybook()
    {
        ...
        $data['page_url']=site_url('Adminsubject/mybook'). $pageurl.'/';

        if(!empty($pid))
        {
            if($page_count == 0)
            {
                $data['page_url']=site_url('Adminsubject/mybook').'/';
                $page_count = 1;
            }
        }
    ...
    public function courseframe()
    {
        ...
        $this->load->view('admin/courseframe', $data);
    }
    ...
    public function addsection()
    {
        ...
        $this->load->view('admin/section_add', $data);
    }
...
//        p($where);
    ...
    public function myexam()
    {
        ...
        $page_count = ceil($data['total_rows']/10);
        $data['page_url'] = site_url('Adminsubject/myexam') . $pageurl.'/';
        $data['page_count'] = $page_count;
        $data['page_pre']=$page;
    ...
    public function editexam()
    {
        ...
        $this->load->view('admin/exam_edit', $data);
    }
    ...
    public function questionlist()
    {
        ...
        //场景
        $ctfs = $this->Question_model->get_ctf(array());
        ...
        $data['page_url']=site_url('Adminsubject/questionlist').$pageurl .'/';
    ...
    public function toollist()
    {
        ...
        $data['page_url'] = site_url('Adminsubject/toollist') . $pageurl.'/';

        $data['page_count']=$page_count;
        $data['page_pre']=$page;


        $this->load->view('admin/tool_list', $data);
    }
    ...
    public function addtool()
    {
        ...
        else
        {
            ...
            $this->load->view('admin/addtool', $data);
        }
    ...
    public function toolcate()
    {
        ...
        $this->load->view('admin/toolcate', $data);
    }
    ...
    */
    ...
    public function bookdetail(){
        ...
        $this->load->view('admin/edu_book_detail',$data);
    }
    /**
     * 小节详情页
     */
    public function sectiondetail(){
        ...
        if ($pack != 1) {
            ...
            redirect('Adminsubject/bookdetail?packageid='.$packageID);
        ...
        if ($data['section'][0]['SectionType'] == 1) {
        ...
        $this->load->view('admin/edu_section_detail',$data);
    }
    //所有老师创建的试卷--详情
    public function examquestion(){
        ...
        $this->load->view('admin/exam_question',$data);
    }
