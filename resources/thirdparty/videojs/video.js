...
for (var errNum = 2; errNum < MediaError.errorTypes.length; errNum++) {
  MediaError[MediaError.errorTypes[errNum]] = errNum;// 原始数据errNum = 0;暂时解决可播放的情况下，出现的页面报错，会导致如果真的视屏无法通过video.js播放时，不奔放提醒用户
...
var Player = (function (_Component) {
  ...
  // Player.prototype.remainingTime = function remainingTime() {
  //     var nnnn = this.duration() - this.currentTime();


  //     //修改的学生端得分弹框
  //     // var myTitle= document.getElementById('no-student');  
  //     // if(myTitle > 10){
  //       if(nnnn != 0 && nnnn<20){
  //         this.pause();
  //         videoPlayEnd();//火狐兼容
  //         videoPlayEnd(event);//谷歌兼容
...
var Flash = (function (_Tech) {
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    if (!options.swf) {
      options.swf = '../../resources/thirdparty/videojs/video-js.swf';
    }
...
var Tech = (function (_Component) {
  ...
  Tech.prototype.emulateTextTracks = function emulateTextTracks() {
    ...
    if (!_globalWindow2['default']['WebVTT'] && this.el().parentNode != null) {
      ...
      script.src = this.options_['vtt.js'] || '../../resources/thirdparty/videojs/vtt.min.js';
