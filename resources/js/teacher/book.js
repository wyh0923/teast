...
$(function () {
    ...
    $(".clsearch").click(function(){
        ...
        if(pid == '' && aid == ''){
            window.location.href=site_url + 'Subject/mybook' + "/search/"+encodeURI(search);
        }
        if(pid != '' && aid == ''){
            window.location.href=site_url + 'Subject/mybook' + "/search/"+encodeURI(search)+ '/pid/'+ pid;
        }
        if(pid != '' && aid != ''){
            window.location.href=site_url + 'Subject/mybook' + "/search/"+encodeURI(search)+ '/pid/'+ pid+ '/aid/'+ aid;
        }
    ...
    $('#PackageDiff,#SectionNum,#PracticeSectionNum').click(function(){
        ...
        if(code == 'DESC'){
            location.href = site_url+'Subject/mybook' + str + '/sort/'+field+' ASC';
        }else if(code == 'ASC'){
            location.href = site_url+'Subject/mybook' + str + '/sort/'+field+' DESC';
        }else{
            location.href = site_url+'Subject/mybook' + str + '/sort/'+field+' DESC';
        }
    });
    ...
    $('#addbook').click(function () {
        ...
        $.ajax({
           url: site_url + 'Subject/doaddbook',
            type: 'post',
            data: data,
            dataType: 'json',
            success: function (msg) {
                if(msg.code == '0000')
                {
                    ...
                    setTimeout(function(){
                        window.location.href = site_url+ 'Subject/mybook';
                    },1000);
                } else {
    ...
    $('#addchaBox #ok').click(function () {
        ...
        $.ajax({
            url:site_url+"Subject/addchapter",
            type:'post',
    ...
    $('#modchaBox #ok').click(function () {
        ...
        $.ajax({
            url:site_url+"Subject/modchapter",
            type:'post',
    ...
    $('#delchaBox #ok').click(function () {
        ...
        $.ajax({
            url:site_url+"Subject/delchapter",
            type:'post',
            data:{'chaid': chaid},
            dataType:'json',
            success:function(message){
    ...
    $('#delsecBox #ok').click(function () {
        ...
        $.ajax({
            url:site_url+"Subject/delsection",
            type:'post',
    ...
    $('.editcourse').click(function () {
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                {
                    window.location.href = site_url+"Subject/editbook/cid/"+cid;
                }
            }
        });
...
function quotelist(cid){
    //alert(pid);return;
    $.ajax({
        url:site_url+'Subject/quote_list',
        type:'post',
        data:{cid:cid},
        dataType:'json',
        success:function(message){
