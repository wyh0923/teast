...
$(function () {
    $(".csys").click(function(){
        ...
        window.location.href=site_url + 'Subject/mysystem' + "/search/"+encodeURI(search);
    });
    ...
    $('#PackageCount,#SectionNum,#TestNum').click(function(){
        ...
        if(code == 'DESC'){
            location.href = site_url+'Subject/mysystem' + str + '/sort/'+field+' ASC';
        }else if(code == 'ASC'){
            location.href = site_url+'Subject/mysystem' + str + '/sort/'+field+' DESC';
        }else{
            location.href = site_url+'Subject/mysystem' + str + '/sort/'+field+' DESC';
        }
    });
