...
$(function(){
    ...
    $("#ctfBtn").click(function(){
        ...
        sapGetData(site_url+'/Adminsubject/ctflist', ctfLists, "ctfPage");
    ...
    $("#secnBtn").click(function(){
        ...
        sapGetData(site_url+'/Adminsubject/scenelist', seceLists, "secePage");
        ...
        $.ajax({
            ...
            success: function (message) {
                ...
                if(message.code != '0000'){
                    ...
                    setTimeout(function(){
                        window.location.href = site_url + '/Adminsubject/questionlist';
                    },  1000);
                }
    ...
    $("#editQueList").click(function(){
        ...
        $.ajax({
            url: site_url + "/Adminsubject/modquestion",
            type: 'post',
            data: {
                'qid': qid,
                'QuestionDesc': tigan,
