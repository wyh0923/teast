...
$(function () {
    ...
    $(".csear").click(function(){
        ...
        window.location.href=site_url + '/Adminsubject/myexam' +str+ "/search/"+encodeURI(search);
    });
    ...
    $(".ismod").click(function(){
        ...
        $.ajax({
            url: site_url + '/Adminsubject/isfinish',
            data: {'qid': code},
            type: 'post',
            dataType: 'json',
            success: function (msg) {
                ...
                if (msg.code == '0000') {
                    ...
                    window.location.href= site_url +'/Adminsubject/editexam/eid/'+ code +'/name/'+ name +'/diff/'+ diff;
                }
            }
        });
    ...
    $('#CreateTime,#ExamName,#TeacherID').click(function(){
        ...
        if(code == 'DESC'){
            location.href = site_url+'/Adminsubject/myexam' + str + '/sort/'+field+' ASC';
        }else if(code == 'ASC'){
            location.href = site_url+'/Adminsubject/myexam' + str + '/sort/'+field+' DESC';
        }else{
            location.href = site_url+'/Adminsubject/myexam' + str + '/sort/'+field+' DESC';
        }
    });
    ...
    $('#eOk').click(function(){
        ...
        $.ajax({
            url:site_url+"/Adminsubject/delexam",
            type:'post',
            data:{'code':cid},
            dataType:'json',
    ...
    $('#addOk').click(function () {
        ...
        for(i=0;i<childLength;i++){
            ...
            var qltype = $("#queBox").children().eq(i).find(".delate").attr('qltype');
        ...
        $.ajax({
            url:site_url+"/Adminsubject/doaddexam",
            type:'post',
            dataType:'json',
            ...
            success:function(message)
            {
                if(message.code=='0000'){
                    ...
                    setTimeout(function(){
                        window.location.href=site_url + "/Adminsubject/myexam";
                    },1000);
                } else {
    ...
    $('#editsave').click(function () {
        ...
        //提交更改的数据
        $.ajax({
            url : site_url+'/Adminsubject/modexam',
            beforeSend : function(){
    ...
    $("#addquestion").click(function(){
        ...
        var url = site_url+'/Adminsubject/all_question';
    ...
    $(".clickSear").click(function(){
        sapGetData(site_url+'/Adminsubject/all_question', sapSuc, "pageContainer");
...
function searchForTime(){
    if($("#stime").val() != "" && $("#etime").val() != ""){
        if($("#stime").val() >= $("#etime").val()){
            ...
            window.location.href =  site_url+'/Adminsubject/myexam' + str +'/time/'+ $("#stime").val() + "_" + $("#etime").val()
        }
    }
...
function clearTime() {
    if ($("#stime").val() == "" && $("#etime").val() == "") {
        var str = '';
        if (search != '')str += '/search/' + encodeURI(translate(search));
        window.location.href = site_url + '/Adminsubject/myexam' + str;
    }
}