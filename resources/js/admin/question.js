...
$(function () {
    ...
    $(".cquestion").click(function(){
        ...
        window.location.href=site_url + '/Adminsubject/questionlist'+ str + "/search/"+encodeURI(search);
    });
    ...
    $('.author').click(function () {
        ...
        if(uname != '') {
            location.href = site_url+'/Adminsubject/questionlist' + str + '/uname/'+ uname;
        } else {
            location.href = site_url+'/Adminsubject/questionlist' + str ;
        }
    });
    ...
    $('.mold').click(function () {
        ...
        if(qtype != '') {
            location.href = site_url+'/Adminsubject/questionlist' + str + '/qtype/'+ qtype;
        } else {
            location.href = site_url+'/Adminsubject/questionlist' + str ;
        }
    });
    ...
    $('#QuestionAuthor,#QuestionType').click(function(){
        ...
        if(code == 'DESC'){
            location.href = site_url+'/Adminsubject/questionlist' + str + '/sort/'+field+' ASC';
        }else if(code == 'ASC'){
            location.href = site_url+'/Adminsubject/questionlist' + str + '/sort/'+field+' DESC';
        }else{
            location.href = site_url+'/Adminsubject/questionlist' + str + '/sort/'+field+' DESC';
        }
    });
    ...
    $('.ismod').click(function () {
        ...
        $.ajax({
            url: site_url + '/Adminsubject/isrelation',
            data: {'qid': qid},
            type: 'post',
            dataType: 'json',
            success: function (msg) {
                if (msg.code == '0000') {
                    ...
                    window.location.href = site_url +'/Adminsubject/editquestion/qid/'+ qid;
                }
            }
        });
    });
    ...
    $('#qOk').click(function(){
        ...
        $.ajax({
            url:site_url+"/Adminsubject/delquestion",
            type:'post',
            data:{'cid':cid},
            dataType:'json',
    ...
    $('#addQues').click(function(){
        ...
        $.ajax({
            url:site_url+"/Adminsubject/addquestion",
            type:'post',
            data:{'cid':cid},
            dataType:'json',
            success:function(message){
