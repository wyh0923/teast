...
$(function () {
    ...
    $(".clsearch").click(function(){
        sapGetData(site_url+'/Adminsubject/ajax_course', sapSuc, "pageContainer");
    });
    ...
    $('#addsBox #addOk').click(function () {
        ...
        $.ajax({
            url: site_url+ '/Adminsubject/addsys',
            type: 'post',
            dataType: 'json',
    ...
    $('#modsys #ok').click(function () {
        ...
        $.ajax({
            url: site_url+ '/Adminsubject/modplan',
            type: 'post',
            dataType: 'json',
            data: {name: name, pid: pid},
            success: function (msg) {
    ...
    $('.selcour').click(function () {
        ...
        $(".iptSearch-a").val('')
        sapGetData(site_url+'/Adminsubject/all_course', sapSuc, "pageContainer");
    ...
    $('#selcourse #ok').click(function () {
        ...
        $.ajax({
            url: site_url+ '/Adminsubject/optcourse',
            type: 'post',
            dataType: 'json',
    ...
    $('#editsBox #ok').click(function () {
        ...
        $.ajax({
            url: site_url+ '/Adminsubject/modsysname',
            type: 'post',
            dataType: 'json',
    ...
    $('#delsys #ok').click(function () {
        ...
        $.ajax({
            url: site_url+ '/Adminsubject/delsys',
            type: 'post',
            dataType: 'json',
            data: {aid: aid},
            success: function (msg) {
    ...
    $('#delcourse #ok').click(function () {
        ...
        $.ajax({
            url: site_url+ '/Adminsubject/delcourse',
            type: 'post',
            dataType: 'json',
            data: {cid: aid},
            success: function (msg) {
...
function getSysFilter(pid)
{
    ...
    $.ajax({
        type:"post",
        url:site_url+"/Adminsubject/ajaxSysFilter",
        data:data,
        dataType:"json",
        success:function(msg){
            // console.log(msg);
