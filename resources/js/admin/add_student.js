            ...
            success: function (msg) {
                if (msg.code == '0000') {
                    ...
                    setTimeout(function(){
                        ...
                        window.location.href = siteurl+'/User/student';
                    },2000);
                } else {
        ...
        $.ajax({
            ...
            success: function (msg) {
                if (msg.code == '0000') {
                    ...
                    setTimeout(function(){
                        fnHide("#okBox","fadeInDown","fadeOutUp");
                        window.location.href = siteurl+'/User/addstudent';
                    },2000);
                } else {
                    $('#okBox p.promptNews').html(msg.msg);
                    fnShow("#okBox","fadeOutUp","fadeInDown");
...
var upadd = $('#edituploadIcon').Huploadify({
    ...
    uploader:siteurl+'/User/uploadcsv/student',//服务器端脚本文件路径
...
$('#inputAddBtn').click(function(){
    ...
    if(trLength>0){
        ...
        if(filecsv!=''){
            $.ajax({
                url : siteurl+'/User/import_student',
                type : 'post',
                ...
                success : function(msg){
                    if (msg.code == '0000'){
                        ...
                        fnShow("#okBox","fadeOutUp","fadeInDown");
                        setTimeout(function(){window.location.href = siteurl+'/User/student';},2000);
