...
function typesel(){
    ...
    window.location.href=site_url+"/Adminsubject/toollist/type/"+ typeid;
}
...
$(function(){
    ...
    $('.entsearch').keydown(function(e){
        if(e.keyCode==13){
            ...
            window.location.href=site_url+'/Adminsubject/toollist' + str;
        }
    });
    ...
    $('#updateTime').click(function(){
        ...
        if(code == 'DESC'){
            location.href = site_url+'/Adminsubject/toollist' + str + '/sort/'+field+' ASC';
        }else if(code == 'ASC'){
            location.href = site_url+'/Adminsubject/toollist' + str + '/sort/'+field+' DESC';
        }else{
            location.href = site_url+'/Adminsubject/toollist' + str + '/sort/'+field+' DESC';
        }
    });
    ...
    $(".ccate").click(function(){
        ...
        window.location.href=site_url+'/Adminsubject/toolcate' + "/search/"+encodeURI(search);
    });
    ...
    $('#savecate').click(function () {
        ...
        if(cname== ''){
            ...
            $.ajax({
                url:site_url+"/Adminsubject/modtype",
                type:'POST',
    ...
    $('#deltype').click(function () {
        ...
        $.ajax({
            url:site_url+"/Adminsubject/deltype",
            type:'POST',
            data:{typeId: cid},
            dataType:"json",
            success:function(msg){
    ...
    $('#okBtn').click(function(){
        ...
        $.ajax({
            url:site_url+"/Adminsubject/del_tool",
            type:'post',
            ...
            success:function(message){
                ...
                if(message.code=='0000'){
                    ...
                    setTimeout(function () {
                        window.location = site_url+"/Adminsubject/toollist";
                    },2000);
                }else{
    ...
    $(".detail").click(function(){
        ...
        var code=$(this).attr('code');
        $.ajax({
            url:site_url+"/Adminsubject/get_detail",
            type:'post',
            data:{'code':code},
            dataType:'json',
            success:function(message){
    ...
    $('#addOk').click(function () {
        ...
        $.ajax({
            url: site_url+ '/Adminsubject/addtype',
            type: 'post',
    ...
    $(".firstOnce .tableUp").click(function()
    {
        ...
        if($("#tool"+pid+" .tableDown").height()>0){
            $.ajax({
                url: site_url+ '/Adminsubject/getchild',
                type: 'post',
                data: {pid: pid},
                dataType: 'json',
                success: function(msg){
...
$(function(){
    ...
    $('#editsBox #ok').click(function () {
        ...
        $.ajax({
            url: site_url+ '/Adminsubject/modtname',
            type: 'post',
